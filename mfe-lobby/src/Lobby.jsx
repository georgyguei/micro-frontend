...
function Lobby() {
  const handleJoin = (game) => {
    // Émettre l'événement sur le bus partagé.
    // mfe-header écoute 'game:joined' et incrémente son badge en réponse.
    // Lobby et Header ne se connaissent pas directement — couplage faible.
    eventBus.emit('game:joined', { name: game.name, id: game.id });
  };
